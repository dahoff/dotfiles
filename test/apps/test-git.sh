...
# Test 8: Install deploys files correctly
info "Test 8: Install and verify git files"
...
# Test 9: Installed .gitconfig has correct content
info "Test 9: Verify installed .gitconfig content"
if grep -q "gitconfig.local" "$HOME/.gitconfig"; then
    pass "Installed .gitconfig has local include"
else
    fail "Installed .gitconfig missing local include"
fi

# Test 10: Uninstall removes files
info "Test 10: Uninstall removes git files"
...
# Test 11: .gitconfig does not contain secrets
info "Test 11: No secrets in .gitconfig"
...
echo
echo "======================================"
echo -e "${GREEN}All 11 git module tests passed!${NC}"
echo "======================================"
